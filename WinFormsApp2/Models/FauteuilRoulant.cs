...
{
    public class FauteuilRoulant : Vehicule
    {
        private const float GRAVITE = 9.81f;
        private const double POIDS_STANDARD = 100.0;
        private const double MODIFICATEUR_FREINAGE = 1.2;

        public FauteuilRoulant()
        {
            Type = TypeVehicule.FauteuilRoulant;
        ...
        public override string ObtenirNom() => "Fauteuil Roulant";
    }
}
